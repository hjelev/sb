//! Overlay-panel renderers (integrations, help, bookmarks, sort, settings, shortcuts,
//! plugins, themes). Split from panels.rs; re-exported there so `ui::panels::*` paths hold.
