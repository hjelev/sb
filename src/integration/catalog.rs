...
pub fn integration_catalog() -> Vec<IntegrationSpec> {
    vec![
        ...
        IntegrationSpec { key: "glow", description: "Markdown preview (pane + Enter)", category: "viewer", required: false },
        IntegrationSpec { key: "mmdflux", description: "Mermaid diagram preview (pane + Enter, .mmd)", category: "viewer", required: false },
        IntegrationSpec { key: "links", description: "HTML preview (pane + Enter)", category: "viewer", required: false },
        IntegrationSpec { key: "pdftotext", description: "PDF text preview (pane + Enter)", category: "preview", required: false },
        ...
        IntegrationSpec { key: "sqlite3", description: "SQLite table/row preview (pane + Enter, .db/.sqlite/...)", category: "preview", required: false },
        IntegrationSpec { key: "xleak", description: "Excel/ods spreadsheet viewer (pane + Enter, .xlsx/.xls/.ods)", category: "preview", required: false },
        IntegrationSpec { key: "doxx", description: "Word document viewer (pane + Enter, .docx)", category: "preview", required: false },
        IntegrationSpec { key: "delta", description: "side-by-side colored compare (C: marked file vs cursor)", category: "diff", required: false },
        IntegrationSpec { key: "diffnav", description: "file-tree diff navigator for git diff preview (G)", category: "diff", required: false },
        IntegrationSpec { key: "hexyl", description: "hex view for binary files (pane + Enter)", category: "preview", required: false },
        ...
        IntegrationSpec { key: "sox", description: "play audio on Enter, tag info in pane (soxi)", category: "preview", required: false },
        ...
        IntegrationSpec { key: "wget", description: "download files from URL (w, preferred downloader)", category: "network", required: false },
        IntegrationSpec { key: "curl", description: "download files from URL (w fallback, redirects supported)", category: "network", required: false },
        IntegrationSpec { key: "tmux", description: "split shell + less preview (i), editor (E)", category: "terminal", required: false },
        IntegrationSpec { key: "zellij", description: "split shell + preview/editor (i / E), tmux fallback", category: "terminal", required: false },
...
pub fn integration_brew_package(key: &str) -> Option<&'static str> {
    match key {
        ...
        "diffnav" => Some("dlvhdr/formulae/diffnav"),
        "xleak" => Some("bgreenwell/tap/xleak"),
        "doxx" => Some("doxx"),
        "hexyl" => Some("hexyl"),
