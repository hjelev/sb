...
pub fn integration_catalog() -> Vec<IntegrationSpec> {
    vec![
        ...
        IntegrationSpec { key: "sqlite3", description: "SQLite table/row preview on Enter (.db/.sqlite/.sqlite3/...)", category: "preview", required: false },
        IntegrationSpec { key: "xleak", description: "Excel/ods spreadsheet viewer on Enter (.xlsx/.xls/.ods)", category: "preview", required: false },
        IntegrationSpec { key: "doxx", description: "Word document viewer on Enter (.docx)", category: "preview", required: false },
